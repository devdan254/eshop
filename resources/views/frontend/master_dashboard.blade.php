        ...
        $.ajax({
            ...
            success:function(data){
                ...
                <tr>
                    ...
                    <td class="cart_total_amount">
   <h6 class="text-brand text-end">${data.coupon_name} ( ${data.coupon_discount}% ) <a type="submit" onclick="couponRemove()"><i class="fi-rs-trash text-danger"></i> </a> </h6>
                    </td>
                </tr>
                <tr>
                    <td class="cart_total_label">
