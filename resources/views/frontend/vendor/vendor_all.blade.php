...
<div class="page-header breadcrumb-wrap">
  ...
  <a href="{{ route('vendor.details', ['id' => $vendor->id, 'name' => $vendor_name_slug]) }}">
     <img class="default-img" src="{{ (!empty($vendor->photo)) ? url('uploads/vendor_images/'.$vendor->photo):url('uploads/no_image.jpg') }}" style="width:120px;height: 120px;" alt="" />
                                    </a>
                                </div>
   ...
   <h4 class="mb-5"><a href="{{ route('vendor.details', ['id' => $vendor->id, 'name' => $vendor_name_slug]) }}">{{ $vendor->name }}</a></h4>
 ...
 $products = App\Models\Product::where('vendor_id',$vendor->id)->get();
   ...
   <span class="font-small total-product">{{ count($products) }} products</span>
                                ...
                                <a href="{{ route('vendor.details', ['id' => $vendor->id, 'name' => $vendor_name_slug]) }}" class="btn btn-xs">Visit Store <i class="fi-rs-arrow-small-right"></i></a>
                            </div>
                        </div>
                    </div>
                    <!--end vendor card-->
