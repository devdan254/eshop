...
<table class="table thead-light" style="font-weight: 600;"  >
<tbody>
...
@else 
 ...
 <div class="form-group col-6" style=" font-weight: 600; font-size: initial; color: #000000;
">
                    <label>Order Return Reason</label>
                    <textarea rows="6" name="return_reason" class="form-control"></textarea>
                    <button type="submit" class="btn-sm btn-danger mt-2">Order Return</button>
                </div>
