	...
	<div class="card">
		<div class="card-body">
			...
			<div class="row mb-3">
				...
				<div class="col-sm-9 text-secondary">
					 <img id="showImage" src="{{ (!empty($inactiveVendorDetails->photo)) ? url('uploads/vendor_images/'.$inactiveVendorDetails->photo):url('uploads/no_image.jpg') }}" alt="Vendor" style="width:100px; height: 100px;"  >
				</div>
			</div>
