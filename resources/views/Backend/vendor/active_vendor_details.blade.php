	...
	<div class="card">
		...
		<input type="hidden" name="id" value="{{ $activeVendorDetails->id }}">
			...
			<div class="row mb-3">
				...
				<div class="col-sm-9 text-secondary">
					 <img id="showImage" src="{{ (!empty($activeVendorDetails->photo)) ? url('uploads/vendor_images/'.$activeVendorDetails->photo):url('uploads/no_image.jpg') }}" alt="Vendor" style="width:100px; height: 100px;"  >
				</div>
			</div>
