                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-9 text-secondary">
                                    <img id="showImage" src="{{ !empty($vendorData->photo)? url('uploads/vendor_images/'.$vendorData->photo): url('uploads/no_image.jpg') }}" alt="Admin"  width="110" style="width: 100px;height:100px ">
                                </div>
                            </div>
