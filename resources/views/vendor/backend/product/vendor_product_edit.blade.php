...
<div class="page-content col-lg-8">
    <div class="card">
        <div class="card-body p-4">
            <h5 class="card-title">Add More Images</h5>
        </div>
        <form method="post" action="{{ route('vendor.additional.product.multiimage') }}" enctype="multipart/form-data" >
            @csrf
        <div class="mb-3 p-4">
            <label for="inputProductTitle" class="form-label">Add Multiple Images</label>
            <input type="hidden" name="product_id" value="{{ $products->id }}">
            <input class="form-control" name="additional_images[]" type="file" id="multiImg" multiple="">
    
        <div class="row" id="preview_img"></div>
        <input type="submit" class="btn btn-primary px-4 mt-2" value="Add Images" />
          </div>
