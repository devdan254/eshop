...
class VendorProductController extends Controller
{
 ...
 public function VendorGetSubCategory($category_id){
    ...
    public function VendorStoreProduct(Request $request){
        ...
        Image::read($image)->resize(800,800)->save('uploads/products/thambnail/'.$name_gen);
        ...
        Image::read($img)->resize(800,800)->save('uploads/products/multi-image/'.$make_name);
    ...
    public function VendorUpdateProduct(Request $request){ 
     ...
     /// Add  Multiple Images Upload From Edit Page//////
     public function VendorProductAdditionalImages(Request $request){
